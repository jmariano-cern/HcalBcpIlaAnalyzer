    ...
    def get_frames(self,data):
        ...
        while (frame_index+self.framelength < len(data)):
            ...
            if (checkframe == self.frameword):
                ...
                frames.append(next_frame)
                frame_index=frame_index+self.framelength
                self.logfile.write("ERROR: badframe! Expected " + self.frameword + " or " + self.bc0word + " but got " + checkframe + "\n")
                print "ERROR: badframe! Expected " + self.frameword + " or " + self.bc0word + " but got " + checkframe
                wasfail=True
                #exit()
        if wasfail:
            self.logfile.write("There were some frame errors... heres the raw data...\n")
